...
\ifPDFTeX
% Minimal pdfLaTeX setup (but you should use XeLaTeX)
\usepackage[T1]{fontenc}
\usepackage[utf8]{inputenc}
\usepackage{lmodern}
\makeatletter
% http://tex.stackexchange.com/questions/323570/
\renewcommand*{\UTFviii@defined}[1]{\ifx#1\relax\textvisiblespace\else\expandafter#1\fi}
\makeatother
...
% ESH-inline-verb is for commands which (like \verb) use the same delimiter
% before and after their argument: \verb|abc|, \verb/abc/, \verb,abc,
%% ESH-inline-verb: c-mode \cverb
%% ESH-inline-verb: java-mode \javaverb
%% ESH-inline-verb: python-mode \pythonverb
%% ESH-inline-verb: emacs-lisp-mode \normallisp
%% ESH-inline-verb: prettified-emacs-lisp-mode \prettylisp

% ESH-inline-command is for commands which (like \texttt) use a pair of curly
% braces to delimit their argument: \textt{abc}.
%% ESH-inline-command: c-mode \textttforc
...
\item Here's some C code: \cverb|int main() { return 0; }|
  \footnote{It also works in footnotes: \textttforc{int main() \{ ...}}
