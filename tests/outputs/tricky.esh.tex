...
\section*{Overlays}
\begin{ESHBlock}
\ESHBol{}\textcolor[HTML]{FF0000}{ab\colorbox[HTML]{00FF00}{cd\ESHSlantItalic{\ESHWeightBold{ef}}}}\ESHBox{#000000}{1.00pt}{\ESHSlantItalic{\ESHWeightBold{\colorbox[HTML]{00FF00}{\textcolor[HTML]{FF0000}{gh}ij}klm}}no}
\end{ESHBlock}
