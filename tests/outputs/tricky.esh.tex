...
\section*{Overlays}
\begin{ESHBlock}
\ESHBol{}\textcolor[HTML]{FF0000}{ab\ESHColorBox{00FF00}{cd\ESHSlantItalic{\ESHWeightBold{ef}}}}\ESHBox{000000}{1.00pt}{\ESHSlantItalic{\ESHWeightBold{\ESHColorBox{00FF00}{\textcolor[HTML]{FF0000}{gh}ij}klm}}no}\uline{before}display\uline{after}
\end{ESHBlock}
